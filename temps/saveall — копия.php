...
if(isset($_POST['eid']))
{
	...
	$tsoni = $_POST['soni'];
	$ball = $_POST['ball'];
	if(($eid == 0) and ($newfan !="") and ($tsoni !="") and ($ball !="")){	
		mysql_query("insert into `test_type`(`name`,`ball`,`soni`) values('$newfan','$ball','$tsoni')");
	}
	if(($eid != 0) and ($newfan !="") and ($tsoni !="") and ($ball !="")){	
		mysql_query("update `test_type` set `name` = '$newfan', `ball` = '$ball', `soni` = '$tsoni' where `id` = '$eid'");
	}
...
if(isset($_POST['testlar'])){
 $_SESSION['act'] = '5';
	...
	for($i = 1; $i <= $tsts;$i = $i + 5){
		$savol = $tst[$i];
		$a = $tst[$i+1];
		$ac = chr(rand(97,122)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(97,122));
		$b = $tst[$i+2];
		$bc = chr(rand(97,122)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(97,122));
		$c = $tst[$i+3];
		$cc = chr(rand(97,122)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(97,122));
		$d = $tst[$i+4];
		$dc = chr(rand(97,122)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(40,94)).chr(rand(97,122));
